...
One situation that can trigger the ((("shuffles", "rolling windows", id="sffrww")))((("rolling windows", "shuffles and", id="rwwsff")))((("shuffles", "map_overlap function", id="sffppf")))((("functions", "map_overlap", id="fctmvp")))((("map_overlap function", id="mpvpfc")))need for a shuffle is a rolling window, where at the edges of a partition your function needs some records from its neighbors.
...
An effective, but expensive, technique to work ((("shuffles", "rolling windows", startref="sffrww")))((("rolling windows", "shuffles and", startref="rwwsff")))((("shuffles", "map_overlap function", startref="sffppf")))((("functions", "map_overlap", startref="fctmvp")))((("map_overlap function", startref="mpvpfc")))around the single-partition look-ahead/look-behind of Dask is to `repartition` your Dask DataFrames.
...
The most efficient aggregations ((("aggregations", "sublinear")))take a sublinear amount of space regardless of the number of records. Some of these can take constant space, such as sum, count, first, minimum, maximum, mean, and standard deviation.
...
To take advantage of efficient ((("aggregations", "built-in")))aggregations, you need to use a built-in aggregation from Dask, or write your own using Dask's aggregation class. Whenever you can, use a built-in. Built-ins not only require less effort, but also are often faster. Not all of the pandas aggregates are directly supported in Dask, so sometimes your only choice is to write your own aggregate.
