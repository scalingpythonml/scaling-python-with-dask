...
Sometimes good documentation exists, but is "separate" from the project (e.g. like books) and some research may be required. If you find a project has good, but not self-evident, documentation consider trying to improve the visibility of the documentation.
