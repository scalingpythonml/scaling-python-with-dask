...
If you don't have time to make your ((("libraries", "evaluating", "contributions, openness to", startref="lbvctb")))((("projects", "library evaluation", "contributions, openness to", startref="pjbvc")))((("contributions, library evaluation and", startref="ctrlbyv")))own test contribution, you can always take a look at a project's pull requests (or equivalent) and see if the responses seem positive or antagonistic.
...
Static typing is frequently ((("static typing")))considered a programming best practice, with some detractors. While the arguments for and against static types inside data pipelines are complex, we believe _some_ typing at the ((("projects", "open source", "evaluating", startref="pjpsvl")))((("open source projects", "evaluation", "code practices", startref="opspjcp")))((("open source projects", "evaluation", "best practices", startref="opspjbp")))library level is something one should expect.
