...
You should try this out now by visualizing everyone's favorite wordcount example from the previous chapter. When you call `dask.visualize` on `words_bag.frequencies()`, you should get a result that looks something like <<vis_ex>>.
