...
To be familiar with Dask, just as in any programming language or framework, you need to understand:

* The deployment framework footnote:[You might not be used to thinking of deployment frameworks if your coming from a single machine background, but you can think of that as what software or hardware needs to be setup for your program to function, like a virtualenv or enough memory or a GPU.] that Dask is able to run on, and thei  strengths and weaknesses.
* The types of data Dask is able to read, how you can interact with the data types in Dask.
* The computational pattern of Dask, how to turn your ideas into Dask code.
* How to monitor and troubleshoot Dask.

You will learn how these concepts apply to Dask generally in this chapter while refining your understanding in the rest of the book.
