...
<h5>Running SQL over dask dataframe with Fugue SQL</h5>

<pre data-type="programlisting"><code class="kn">from</code> <code class="nn">fugue_notebook</code> <code class="kn">import</code> <code class="n">setup</code>
...
<code class="n">ur</code> <code class="o">=</code> <code class="s1">'https://d37ci6vzurychx.cloudfront.net/trip-data/yellow_tripdata_2018-01.parquet'</code>
