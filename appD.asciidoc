...
No streaming section would be complete without wordcount, but it's important to note that our streaming wordcount in <<streaming_wordcount_ex>>&mdash;in addition to the restriction with data loading&mdash;could not perform the aggregation in a distributed fashion.
